...
dataset, classes = loadData(filepath="../soft.txt", has_id=None, class_position='last')
# label = {
#     0: "CD_DVD_Blu-ray_Tools",
#     1: "Maps&GPS",
#     2: "iPod-Tools",
#     3: "Compression-tools",
#     4: "authoring-tools",
...
som = SOM(dataset, (1, len(set(classes))), 10, len(dataset))
layers = som.train()
...
#     with open("data_output/"+str(label[i])+".txt", "a", encoding="utf-8") as f:
#         for m in j:
#             f.write(str(classes[m])+"\n")
...
# print(time.time() - train.start_time)
